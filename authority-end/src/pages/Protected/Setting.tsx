...
import { FiUser, FiBuilding, FiSave, FiEdit3, FiPhone, FiMail, FiMapPin, FiShield } from "react-icons/fi";
		...
		<div className="min-h-screen bg-gray-50">
			<div className="max-w-4xl mx-auto p-6">
				...
				<div className="mb-8">
					...
					<p className="text-gray-600">Manage your account and authority office settings</p>
				</div>
							...
							<div className="p-6 border-b border-gray-200">
								<div className="flex items-center space-x-3">
									<div className="bg-green-100 p-2 rounded-lg">
										<FiBuilding className="h-5 w-5 text-green-600" />
									</div>
									<div>
										<h2 className="text-lg font-semibold text-gray-900">Authority Office</h2>
										<p className="text-sm text-gray-600">Your office information</p>
									</div>
								</div>
							</div>
							<div className="p-6">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									<div>
										...
										<div className="flex items-center space-x-2 p-2 bg-gray-50 rounded-lg">
											<FiBuilding className="h-4 w-4 text-gray-400" />
						...
						<div className="p-6 border-b border-gray-200">
							<div className="flex items-center space-x-3">
								...
								<div>
									...
									<p className="text-sm text-gray-600">Your registered address</p>
								</div>
							</div>
						</div>
						<div className="p-6">
						...
						<div className="p-6">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								...
								<div>
									...
									<div className="text-sm text-gray-600">
										{authority?.createdAt ? new Date(authority.createdAt).toLocaleDateString() : "N/A"}
									</div>
								</div>
							</div>
						</div>

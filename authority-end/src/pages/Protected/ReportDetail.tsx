...
import { AuthorityCommentItem } from "../../components/AuthorityCommentItem";
						...
						<div>
							...
							<div className="space-y-2 text-sm">
								...
								<div className="flex items-center gap-2">
									<FiMapPin size={14} className="text-gray-500" />
									<span>
										{report.authorityOffice.address.city},{" "}
										{report.authorityOffice.address.region}
									</span>
								</div>
							</div>
						</div>
					...
					{commentsLoading ? (
						...
						<div className="space-y-4">
							{comments.map((comment) => (
								<AuthorityCommentItem key={comment.id} comment={comment} />
							))}
						</div>
					) : (

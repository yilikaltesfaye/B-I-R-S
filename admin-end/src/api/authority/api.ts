...
export const authorityApi = {
	// Office Management
	createAuthorityOffice: (payload: CreateAuthorityOfficePauload) =>
		apiClient.post<AuthorityOffice>("/authorities", payload),

	getAllAuthorityOffices: () =>
		apiClient.get<AuthorityOffice[]>("/authorities"),
	...
	updateAuthorityOffice: (id: number, data: Partial<AuthorityOffice>) =>
		apiClient.put<AuthorityOffice>(`/authorities/${id}`, data),

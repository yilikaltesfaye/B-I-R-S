...
const AuthLayout = ({
	...
	return (
		<div className="relative flex flex-col gap-16 h-screen justify-center">
			...
			<div className="relative top-9 sm:top-0 sm:mt-0 flex flex-col justify-between items-center border-l-2 border-r-2 rounded-2xl w-full sm:w-fit self-center shadow-2xl  px-6 sm:px-24 py-1 lg:py-5 xl:py-10 sm:h-fit">
